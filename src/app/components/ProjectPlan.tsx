    ...
    <div className="space-y-4 mt-4">
      <Panel className="p-5">
        <div className="flex items-center gap-3 mb-4 text-primary">
          ...
          <div>
            <div className="text-sm font-medium">Llama 3.3 is analyzing your project…</div>
            <div className="text-xs text-muted-foreground">Generating requirements, architecture, risks & sprint plan</div>
          </div>
        </div>
    ...
    <div className="mt-4">
      <Panel className="p-5">
        <div className="flex items-center gap-3 text-destructive">
          ...
          <div>
            <div className="text-sm font-medium">Plan generation failed</div>
            <div className="text-xs text-muted-foreground">Check your connection or API key and try creating the project again.</div>
          </div>
        </div>
      </Panel>
    </div>
    ...
    <div className="space-y-4">
      <Panel className="p-5">
        <div className="flex flex-wrap items-start justify-between gap-4">
          ...
          <AiTag label="Generated by Llama 3.3 · draft" />
        </div>
        <div className="mt-4">
      ...
      {p.aiPlanStatus === "generating" && <PlanLoadingState />}
      {p.aiPlanStatus === "error" && <PlanErrorState />}
            ...
            <div className="grid gap-4 md:grid-cols-2">
              <PlanCard title="Budget Estimate" editable={editable}>
                ...
                <p className="mt-1 text-xs text-muted-foreground">
                  AI estimate in {p.aiPlan.budget.currency} — not a fixed quote. Spent to date: {money(p.spent)}.
                </p>
                <div className="mt-4">
